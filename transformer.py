...
# transformer Network
class code2commentTransformer(nn.Module):
    ...
    def __init__(self,
                 ...
                 dropout: float = 0.1):
        super(code2commentTransformer, self).__init__()
    ...
    def forward(self,
        ...
        src_emb = src_emb.type(self.data_type)
        tgt_emb = tgt_emb.type(self.data_type)
